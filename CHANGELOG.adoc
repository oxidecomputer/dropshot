...
* https://github.com/oxidecomputer/dropshot/pull/617[#617] Adds support for streaming bodies via the `StreamingBody` extractor.
...
* https://github.com/oxidecomputer/dropshot/pull/755[#755] Adds support for the HEAD method.
