...
+
In this release, the builder interface is not especially nicer than these older functions.  As we look at adding new construction-time options (e.g., for API versioning), those will only be added to the builder.
+
