 ...
 */
pub struct HttpResponseCreated<T: HttpForContent + Send + Sync + 'static>(
    pub T,
);
...
impl<T: HttpForContent + Send + Sync + 'static> From<HttpResponseCreated<T>>
 ...
 */
pub struct HttpResponseAccepted<T: HttpForContent + Send + Sync + 'static>(
    pub T,
);
impl<T: HttpForContent + Send + Sync + 'static> HttpTypedResponse
...
impl<T: HttpForContent + Send + Sync + 'static> From<HttpResponseAccepted<T>>
    for HttpHandlerResult
{
