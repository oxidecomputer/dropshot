...
you will need to have installed the `nightly-2020-10-15` version of the Rust
toolchain:
...
You can then **format the code** using `cargo +nightly-2020-10-15 fmt` or
`rustfmt +nightly-2020-10-15`.  Make sure to run this before pushing changes.
